...
#Recibir un vector en un for y reordenarlo 
#Preguntar si continua dentro de un while

x=input("Ordenar un vector? Ingrese 0 para salir o cualquier otra tecla para continuar ")
while(x!="0"):
